...
query_dict={
    ...
    "flight_info_table":
            ...
            (air_id, air_id_segment, airline, depart_region, depart_airport, arrival_region, 
            arrival_airport, journey_time, connect_time, depart_timestamp, arrival_timestamp, fetched_date)
